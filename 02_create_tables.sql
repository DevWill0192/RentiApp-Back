-- =====================================================
-- PASO 2: CREAR LAS TABLAS EN rentas_app
-- =====================================================
-- Ejecuta este script DESPUÉS de conectarte a rentas_app
-- psql -U postgres -d rentas_app -f 02_create_tables.sql
-- O dentro de psql: \c rentas_app y luego \i 02_create_tables.sql
